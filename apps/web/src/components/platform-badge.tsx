...
const PlatformIcons = {
	...
	MICROSOFT_TEAMS: (
		<svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-3 h-3">
			<path
				d="M12 2C13.1 2 14 2.9 14 4V7H17C18.1 7 19 7.9 19 9V15C19 16.1 18.1 17 17 17H14V20C14 21.1 13.1 22 12 22H7C5.9 22 5 21.1 5 20V9C5 7.9 5.9 7 7 7H12V4C12 2.9 12.9 2 12 2Z"
				fill="#5059C9"
			/>
			<path d="M14 7V17H17C18.1 17 19 16.1 19 15V9C19 7.9 18.1 7 17 7H14Z" fill="#7B68EE" />
			<circle cx="9" cy="11" r="1.5" fill="white" />
			<path
				d="M11.5 13C11.5 13.83 10.83 14.5 10 14.5S8.5 13.83 8.5 13V11C8.5 10.17 9.17 9.5 10 9.5S11.5 10.17 11.5 11V13Z"
				fill="white"
			/>
		</svg>
	)

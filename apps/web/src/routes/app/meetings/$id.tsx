...
import { AlertCircle, ArrowLeft, Bot, Calendar, Clock, Copy, ExternalLink, FileText, LinkedinIcon, Loader2, Mail, MessageSquare, Users } from 'lucide-react'
  ...
  const mockSocialPosts = [
    {
      id: '1',
      platform: 'LinkedIn',
      content: 'Great discussion on AI implementation strategies in our quarterly planning meeting. Key takeaways: focus on user experience and gradual rollout.',
      status: 'posted',
    ...
    },
    {
      id: '2',
      platform: 'Facebook',
      content: 'Exciting team meeting today! We covered new project milestones and upcoming launches. The energy in the room was incredible! 🚀',
      status: 'draft',
...
Meeting Organizer`)
  ...
  const generateSocialPost = async () => {
    ...
    await new Promise(resolve => setTimeout(resolve, 2000))
    const posts = {
      linkedin: 'Just wrapped up an insightful strategy meeting with the team. Key focus areas: innovation, customer experience, and sustainable growth. Excited about the initiatives we discussed! #TeamWork #Strategy',
      facebook: 'Amazing brainstorming session with the team today! 🎯 We covered some exciting new projects and initiatives. Can\'t wait to share more updates soon! #TeamWork #Innovation',
      twitter: 'Great team meeting today! Key takeaways: focus on user experience, sustainable growth, and innovative solutions. Exciting times ahead! 🚀 #TeamWork #Innovation'
    }
  ...
  return (
    <div className="bg-card rounded-lg border">
      <div className="p-6 border-b">
        ...
        <p className="text-sm text-muted-foreground">Generate follow-up emails and social media posts based on your meeting transcript</p>
      </div>
          ...
          <div className="mt-6">
            <TabsContent value="followup" className="space-y-4 m-0">
              ...
              <Textarea
                ...
                placeholder={transcript?.transcript ? "Click 'Generate Email' to create a follow-up email based on your meeting transcript" : "Transcript required to generate email content"}
            ...
            <TabsContent value="draft-generator" className="space-y-4 m-0">
              ...
              <Textarea
                ...
                placeholder={transcript?.transcript ? "Click 'Generate Post' to create content based on your meeting transcript" : "Transcript required to generate social media content"}
